...
namespace EDScreenshotUI
{
    public static class ServiceUtilities
    {
        ...
        public static ServiceController GetService(ServiceController controller, string serviceName)
        {
        ...
        public static void ToggleService(string serviceName)
        {
            ...
            try
            {
                IntPtr service = OpenService(scm, serviceName, ServiceAccessRights.QueryStatus | ServiceAccessRights.PauseContinue);
                if (service == IntPtr.Zero)
                    throw new ApplicationException("Could not open service.");
        ...
        private static void ToggleService(IntPtr service)
        {
            SERVICE_STATUS status = new SERVICE_STATUS();

            ServiceState state = GetServiceStatus(service);
            ...
            else
            {
                ...
                if (!changedStatus)
                    throw new ApplicationException("Unable to continue service");
            }
